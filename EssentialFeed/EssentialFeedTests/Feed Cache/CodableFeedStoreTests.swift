...
//  EssentialFeedTests
//
//  Created by Mariana Alvarez de Carvalho on 14/3/2025.
//
...
final class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_deliversErrorOnInsertionError() {
        let invalidStoreURL = URL(fileURLWithPath: "invalid:/store-url")
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected side-effects to run serially but operation finished in the wrong order")
